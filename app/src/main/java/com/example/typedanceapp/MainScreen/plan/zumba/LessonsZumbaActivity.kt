...
import com.example.typedanceapp.databinding.ActivityLessonsZumbaBinding
import com.google.android.exoplayer2.ExoPlayer
import com.google.android.exoplayer2.MediaItem
import com.google.android.exoplayer2.Player
import com.google.android.exoplayer2.ui.PlayerView

class LessonsZumbaActivity : AppCompatActivity() {

    var isFullScreen = false
    var isLock = false

    private lateinit var binding: ActivityLessonsZumbaBinding
    private lateinit var list: ArrayList<Lessons>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLessonsZumbaBinding.inflate(layoutInflater)
