package com.example.typedanceapp.MainScreen.plan.hiphop
...
class Beg_HipActivity : AppCompatActivity() {

    private lateinit var mediaC: MediaController
    private lateinit var recyclerView: RecyclerView
    private lateinit var list: ArrayList<Lessons>
    lateinit var binding: ActivityBegHipBinding
    private lateinit var databaseReference: DatabaseReference


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBegHipBinding.inflate(layoutInflater)
        ...
        databaseReference.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()){
                    ...
                    val mAdapter = LessonAdapter(list, this@Beg_HipActivity)
                    recyclerView.adapter = mAdapter

                    mAdapter.setOnItemClickListener(object: LessonAdapter.OnItemClickListener{
                        override fun onItemClick(position: Int) {
                            val intent = Intent(this@Beg_HipActivity, LessonsHipHopActivity::class.java)
...
//        binding.videoViewOne.setVideoURI(
//            Uri.parse("android.resource://" + packageName + "/" + R.raw.hip_hop)
//        )
//        myVideo.setVideoURI(
