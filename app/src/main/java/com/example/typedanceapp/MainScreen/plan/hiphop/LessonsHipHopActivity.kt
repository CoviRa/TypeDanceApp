...
import com.example.typedanceapp.databinding.ActivityLessonsHipHopBinding
import com.google.android.exoplayer2.*
import com.google.android.exoplayer2.upstream.DefaultAllocator

class LessonsHipHopActivity : AppCompatActivity() {
    var isFullScreen = false
    var isLock = false

    private lateinit var binding: ActivityLessonsHipHopBinding
    private lateinit var list: ArrayList<Lessons>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLessonsHipHopBinding.inflate(layoutInflater)
